...
// Get current timestamp (shifting it to the next days if $day is > 0 and to the next 4 hours to get next class)
$currentTst = strtotime($current) + 60*60*4 + $day*60*60*24;
$found = 0;
